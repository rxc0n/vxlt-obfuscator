...
return {
	...
	Revision = REVISION;
	-- Config Starts Here
	IdentPrefix = "__vertile_"; -- The Prefix used for Identifiers generated by VERTILE. NOTE: There should be no identifiers in the script to be obfuscated starting with that prefix, because that can lead to weird bugs
